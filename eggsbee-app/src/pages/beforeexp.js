...
function Beforeexp() {
    ...
    function options(){{eggsbeeoptions.map( (eb) =>{
      return { value: eb.Name, label: eb.Name };
    })}}
  return (
    ...
    <div className='mainbody'>
        {loading? <div>This is loading....Please wait as patiently as you can</div>: <div>
            ...
            <h3> <b>Recipe Selected: </b>{recipe.Title}</h3>
            <h4><b>Description:</b>  {recipe.Description}</h4>
